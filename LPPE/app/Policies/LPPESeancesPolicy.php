...
class LPPESeancesPolicy
{
     ...
     */
    public function restore(User $user, LPPE_Seances $lPPESeances): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, LPPE_Seances $lPPESeances): bool
    {
        return false;
    }
}
